...
async function getNumber() {
    ...
    var shoDiv = document.querySelector("#divShoww");
    await axios
        ...
        .then(function(response) {
            ...
            console.log("helo ok" + data.length);
            for (let i = 0; i < data.length; i++) {
                console.log(data[i].table_number);
                document.getElementById("divShoww").innerHTML += data[i].table_number + "<br>" + "<hr>";
                /*$("#divShow").append(`<hr>`);
            ...
            //     new QRCode(document.getElementById("test"), `${num.table_number} points`)
            // });
        })
        .catch(function(error) {
            console.log(error);
